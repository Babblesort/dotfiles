# Generated by Powerlevel10k configuration wizard on 2026-07-03 at 09:34 CDT.
...
() {
  ...
  # Right prompt disabled entirely. Original element list preserved below
  # (assigned to an unused variable) so it can be restored if desired.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=()
  typeset -ga _DISABLED_RIGHT_PROMPT_ELEMENTS=(
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=068
  ...
  typeset -g POWERLEVEL9K_PER_DIRECTORY_HISTORY_LOCAL_FOREGROUND=93
